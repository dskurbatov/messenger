...
var _add_todo = __webpack_require__(72);

var _add_todo2 = _interopRequireDefault(_add_todo);

var _todo_list = __webpack_require__(74);
...
var _set_filter = __webpack_require__(78);

var _set_filter2 = _interopRequireDefault(_set_filter);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
	return {
		onClick: function onClick() {
			dispatch((0, _set_filter2.default)(ownProps.filter));
		}
	};
};
...
var _add_todo = __webpack_require__(73);
...
var AddTodo = function AddTodo(_ref) {
	...
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			'button',
			{ onClick: function onClick() {
					dispatch((0, _add_todo2.default)(input.value));
					input.value = '';
				} },
			'Add Todo'
		)
...
var _toggle_todo = __webpack_require__(77);

var _toggle_todo2 = _interopRequireDefault(_toggle_todo);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	return {
		onTodoClick: function onTodoClick(id) {
			dispatch((0, _toggle_todo2.default)(id));
		}
	};
};
...
var store = (0, _redux.createStore)(_reducer.todoApp, {}, (0, _redux.applyMiddleware)(_reduxLogger2.default, _thunk2.default));
